...
CREATE TABLE `article` (
  ...
  `out_link` varchar(500) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `Article_author_id_5b4dfd9f_fk_UserInfo_id` (`author_id`),
  KEY `Article_category_id_914e6c46_fk_Category_uuid` (`category_id`),
  CONSTRAINT `Article_author_id_5b4dfd9f_fk_UserInfo_id` FOREIGN KEY (`author_id`) REFERENCES `userinfo` (`id`),
  CONSTRAINT `Article_category_id_914e6c46_fk_Category_uuid` FOREIGN KEY (`category_id`) REFERENCES `category` (`uuid`)
...
CREATE TABLE `category` (
  ...
  PRIMARY KEY (`uuid`),
  KEY `Category_parent_id_79e60df4_fk_Category_uuid` (`parent_id`),
  KEY `Category_group_id_8f7b4939_fk_CategoryGroup_id` (`group_id`),
  CONSTRAINT `Category_group_id_8f7b4939_fk_CategoryGroup_id` FOREIGN KEY (`group_id`) REFERENCES `categorygroup` (`id`),
  CONSTRAINT `Category_parent_id_79e60df4_fk_Category_uuid` FOREIGN KEY (`parent_id`) REFERENCES `category` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `menu_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `menu_menu_parent_id_a0981d51_fk_menu_menu_id` (`parent_id`),
  CONSTRAINT `menu_menu_parent_id_a0981d51_fk_menu_menu_id` FOREIGN KEY (`parent_id`) REFERENCES `menu_menu` (`id`)
...
CREATE TABLE `partys` (
  ...
  `parent_id` char(32) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Partys_parent_id_76ca5643_fk_Partys_id` (`parent_id`),
  CONSTRAINT `Partys_parent_id_76ca5643_fk_Partys_id` FOREIGN KEY (`parent_id`) REFERENCES `partys` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `role_menus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Role_menus_role_id_menu_id_aba55671_uniq` (`role_id`,`menu_id`),
  KEY `Role_menus_menu_id_9ed49c6e_fk_menu_menu_id` (`menu_id`),
  CONSTRAINT `Role_menus_menu_id_9ed49c6e_fk_menu_menu_id` FOREIGN KEY (`menu_id`) REFERENCES `menu_menu` (`id`),
  CONSTRAINT `Role_menus_role_id_531ec4f0_fk_Role_id` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`)
...
CREATE TABLE `salarykoukuan` (
  ...
  `year_month_id` char(32) DEFAULT NULL,
  `heji` double NOT NULL,
  PRIMARY KEY (`id`),
  KEY `SalaryKouKuan_year_month_id_eb3a9357_fk_YearAndMonth_id` (`year_month_id`),
  CONSTRAINT `SalaryKouKuan_year_month_id_eb3a9357_fk_YearAndMonth_id` FOREIGN KEY (`year_month_id`) REFERENCES `yearandmonth` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `salaryyingfa` (
  ...
  `danweimingcheng` varchar(100) DEFAULT NULL,
  `renyuanzhuangkuang` varchar(100) NOT NULL,
  `daifayinhang` varchar(100) DEFAULT NULL,
  `yingfagongzi` double NOT NULL,
  `danweidaima` varchar(100) DEFAULT NULL,
  `zhixingshijian` date DEFAULT NULL,
  `shifagongzhi` double NOT NULL,
  `shenfenzhenghao` varchar(100) DEFAULT NULL,
  `xingming` varchar(100) DEFAULT NULL,
  `year_month_id` char(32) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `SalaryYingFa_year_month_id_bf1a7a3a_fk_YearAndMonth_id` (`year_month_id`),
  CONSTRAINT `SalaryYingFa_year_month_id_bf1a7a3a_fk_YearAndMonth_id` FOREIGN KEY (`year_month_id`) REFERENCES `yearandmonth` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `scan_scanresult` (
  ...
  `scanResultText` longtext,
  `scantask_id` bigint NOT NULL,
  `ctime` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `scan_scanresult_scantask_id_6dd007fc_fk_scan_scantask_id` (`scantask_id`),
  CONSTRAINT `scan_scanresult_scantask_id_6dd007fc_fk_scan_scantask_id` FOREIGN KEY (`scantask_id`) REFERENCES `scan_scantask` (`id`)
...
CREATE TABLE `scan_scanresultkeyword` (
  ...
  PRIMARY KEY (`id`),
  KEY `scan_scanresultkeywo_scanResult_id_2a3adad1_fk_scan_scan` (`scanResult_id`),
  CONSTRAINT `scan_scanresultkeywo_scanResult_id_2a3adad1_fk_scan_scan` FOREIGN KEY (`scanResult_id`) REFERENCES `scan_scanresult` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `scores` (
  ...
  `low_score` int DEFAULT NULL,
  `average_score` int DEFAULT NULL,
  `batch_id` bigint NOT NULL,
  `province_id` bigint NOT NULL,
  `subject_category_id` bigint NOT NULL,
  `year_id` bigint NOT NULL,
  `province_score` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Scores_batch_id_8f25ff4b_fk_Batch_id` (`batch_id`),
  KEY `Scores_province_id_72e096b5_fk_Provinces_id` (`province_id`),
  KEY `Scores_subject_category_id_f2928af9_fk_SubjectCategory_id` (`subject_category_id`),
  KEY `Scores_year_id_03c9634b_fk_Years_id` (`year_id`),
  CONSTRAINT `Scores_batch_id_8f25ff4b_fk_Batch_id` FOREIGN KEY (`batch_id`) REFERENCES `batch` (`id`),
  CONSTRAINT `Scores_province_id_72e096b5_fk_Provinces_id` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`id`),
  CONSTRAINT `Scores_subject_category_id_f2928af9_fk_SubjectCategory_id` FOREIGN KEY (`subject_category_id`) REFERENCES `subjectcategory` (`id`),
  CONSTRAINT `Scores_year_id_03c9634b_fk_Years_id` FOREIGN KEY (`year_id`) REFERENCES `years` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1237 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Records of userinfo
-- ----------------------------
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$mn2hedfC2n3iGjDQfX25jZ$JBIDaXAZqwpsPFvoBJYDz1azc6o83pogU9hZ5A2+uHM=', null, '124b826cdc434ec98e6eb10f0fa068f6', '13100001143', '张元元033', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046033', '142423198501270612');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$buTHgANuccK10oSY2aEaNi$L0a48fU5YEkIphswudnY/9rUlcL+t77bw48ybRPqTgE=', null, '1f91dc9bae5e4275b486ab7303c874f9', '13100001135', '张元元025', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046025', '142423198501270612');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$TVaNs17Zhk4nAt8aBODkN2$oyVaO8+Fn3gyLtkYhXHQYn8G21MqnJfICdKGJFQuTvk=', null, '2bbc5b996aa44eca95f491e1bc0f75c8', '13100001118', '张元元008', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046008', '142423198501270612');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000
 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046027', '142423198501270612');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$Alwg9EyfZu5IgpgKWxCubg$QDCL8FGll1dnCY249UVJQDqZgpyiYuCBPPQW59uJzr4=', null, 'd5b39fc95d144b4ea6704e9ba9e6cbe5', '13100001112', '张元元', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046002', '142423198501270611');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$CEDNSPLN0TFVP9BaWNMgK9$iWFEb5nlnhlqez+hd9YcVbFtqdUNvhXr3HhW5d6ZZa4=', null, 'db1ede73955a45d793122510ed836042', '13100001122', '张元元012', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046012', '142423198501270612');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$JaMB48WEDza4QoeZwSeUvc$2o2YmXCICUAib/9PNRCgtFs9HUwtYBUYeahdd/FMTak=', null, 'dda73fd3628e4fa39a84b138074b30ee', '13100001117', '张元元007', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046007', '142423198501270612');
INSERT INTO `userinfo` VALUES ('pbkdf2_sha256$1000000$5CkA5WJFuoLVjGD20CAntK$WatrpjEx0jSh4hb8xYyYzDdexd4iK291GyrW9gzAE/I=', null, 'e8b35bed0af4424a9ed0a71895ff3bbb', '13100001131', '张元元021', 'zyy@qq.com', '1', '0', '0', '2026-01-17 08:07:53.238050', null, '2008046021', '142423198501270612');
...
CREATE TABLE `userinfo_groups` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `userinfo_id` char(32) NOT NULL,
  `group_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UserInfo_groups_userinfo_id_group_id_e48c9e0b_uniq` (`userinfo_id`,`group_id`),
  KEY `UserInfo_groups_group_id_8c6f20ce_fk_auth_group_id` (`group_id`),
  CONSTRAINT `UserInfo_groups_group_id_8c6f20ce_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`),
  CONSTRAINT `UserInfo_groups_userinfo_id_cce2b064_fk_UserInfo_id` FOREIGN KEY (`userinfo_id`) REFERENCES `userinfo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `userinfo_roles` (
  ...
  `role_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UserInfo_roles_userinfo_id_role_id_63c17ff2_uniq` (`userinfo_id`,`role_id`),
  KEY `UserInfo_roles_role_id_08c60e00_fk_Role_id` (`role_id`),
  CONSTRAINT `UserInfo_roles_role_id_08c60e00_fk_Role_id` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`),
  CONSTRAINT `UserInfo_roles_userinfo_id_311a043d_fk_UserInfo_id` FOREIGN KEY (`userinfo_id`) REFERENCES `userinfo` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `userinfo_user_permissions` (
  ...
  `permission_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UserInfo_user_permission_userinfo_id_permission_i_66942a42_uniq` (`userinfo_id`,`permission_id`),
  KEY `UserInfo_user_permis_permission_id_c7ea8d38_fk_auth_perm` (`permission_id`),
  CONSTRAINT `UserInfo_user_permis_permission_id_c7ea8d38_fk_auth_perm` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`),
  CONSTRAINT `UserInfo_user_permissions_userinfo_id_d4fb0c61_fk_UserInfo_id` FOREIGN KEY (`userinfo_id`) REFERENCES `userinfo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `yearandmonth` (
  ...
  `month` int NOT NULL,
  `beizhu` longtext,
  `year_month` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
